...
final class BackupTableRegistry
{
    ...
    public function tables(): array
    {
        return [
            ...
            $this->table('library_game_progress_links', 'library_game_progress_links', 'data/core/library_game_progress_links.ndjson', ['id', 'user_id', 'target_library_game_id', 'source_library_game_id', 'sync_playtime', 'sync_achievements', 'sync_dates', 'sync_status', 'created_at', 'updated_at'], canBeMissingFromReleasedBackups: true),
            ...
            $this->partitionedTable('library_game_progress_link_snapshots', 'library_game_progress_link_snapshots', 'data/snapshots/library_game_progress_link_snapshots', ['id', 'snapshot_run_id', 'library_game_progress_link_id', 'target_library_game_id', 'source_library_game_id', 'sync_playtime', 'sync_achievements', 'sync_dates', 'sync_status', 'created_at', 'updated_at'], canBeMissingFromReleasedBackups: true),
    ...
    private function table(string $name, string $table, string $path, array $columns, bool $canBeMissingFromReleasedBackups = false): BackupTableDefinition
    {
        return new BackupTableDefinition($name, $table, $path, $columns, canBeMissingFromReleasedBackups: $canBeMissingFromReleasedBackups);
    }

    private function partitionedTable(string $name, string $table, string $path, array $columns, bool $canBeMissingFromReleasedBackups = false): BackupTableDefinition
    {
        return new BackupTableDefinition($name, $table, $path, $columns, true, $canBeMissingFromReleasedBackups);
    }
}
