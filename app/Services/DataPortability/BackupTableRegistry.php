...
final class BackupTableRegistry
{
    ...
    public function tables(): array
    {
        return [
            ...
            $this->table('library_game_progress_links', 'library_game_progress_links', 'data/core/library_game_progress_links.ndjson', ['id', 'user_id', 'target_library_game_id', 'source_library_game_id', 'sync_playtime', 'sync_achievements', 'sync_dates', 'sync_status', 'created_at', 'updated_at']),
