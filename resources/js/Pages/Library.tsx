        ...
        <AppLayout title="Library" lockViewport>
            <section className="flex h-full flex-col pl-[88px]">
                ...
                <div className="mb-4 grid grid-cols-[minmax(360px,560px)_1fr_1fr] items-center gap-4">
                    ...
                    <button className="flex h-[56px] items-center gap-3 rounded-full bg-[#b7ff63] px-8 text-xl font-black shadow-[0_14px_30px_rgb(0_0_0/0.06)]"><SlidersHorizontal /> Sort</button>
                    <button className="flex h-[56px] items-center gap-3 rounded-full bg-black px-8 text-xl font-black text-[#b7ff63] shadow-[0_14px_30px_rgb(0_0_0/0.12)]"><Filter /> Filter</button>
                </div>
